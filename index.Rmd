...
.footnotesize[<sup>2</sup>Stanford University, CESiso, IZA, NBER]
...
* Primary development goal: all youths around the world achieve at least basic skills 
...
## Our research goal
1. Provide the best estimates of share of children not achieving basic skills in all countries of the world 
...
# 2. Constructing a Global Data Base
...
At least PISA Level 2 (420 points in math and 410 for science)
]
...
- **China**: Use 2014 wave of the China Family Panel Studies (CFPS) to **re-center PISA scores** 
...
# 4. The Economic Gains from Global Universal Basic Skills
...
where $\gamma$ is thes estimated impact of aggregated skills on growth rates and $\bar{A_{\tau}}$ are the skills of the workforce 
...
- At least 2/3 of the world’s youth do not obtain basic skills. 
- In high-income countries, 25 % of children lacks basic skills. 
...
- **Lower bound:** PISA 2018 results for urban population, all rurual children below basic skills
